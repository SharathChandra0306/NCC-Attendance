...
const Students = () => {
  ...
  const [loading, setLoading] = useState(true);
             <div>
              ...
              />
            </div>archTerm, setSearchTerm] = useState('');
                ...
                <tr key={student._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="text-sm text-gray-900">{student.attendanceRate.toFixed(1)}%</div>
...
const StudentModal = ({ student, onClose, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-4 sm:top-20 mx-auto p-4 sm:p-5 border w-full max-w-lg sm:max-w-md shadow-lg rounded-md bg-white">
        <div className="mt-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                >
                  ...
                  {['Alpha', 'Beta', 'Charlie', 'Delta'].map(company => (
