...
const Students = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4 sm:p-6 overflow-x-hidden">
                ...
                <div key={student._id} className="border border-gray-200 rounded-lg p-4 space-y-3">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      {student.email && <p className="text-sm text-gray-500 break-words">{student.email}</p>}
                    </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {students.map((student, index) => (
                  <tr key={student._id} className="hover:bg-gray-50">
                    <td className="px-2 sm:px-3 py-3 whitespace-nowrap text-sm text-gray-900">{index + 1}</td>
                    ...
                    <td className="px-2 sm:px-3 py-3 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="text-xs text-gray-900 mr-1">{(student.attendanceRate || 0).toFixed(0)}%</div>
                    ...
                    <td className="px-2 sm:px-3 py-3 whitespace-nowrap text-sm font-medium">
